...
public class MainBenchmarkTestCopy {
        ...
        public static Move findBestMoveAlphaBeta(Board board, long timeLimitMs, boolean alphaBeta, boolean pvs, boolean transpositionTable, boolean killerHeuristik, boolean LateMoveReductions, int lmrDepth, int lmrMoves) {
            ...
            tablut.Tools.MainBenchmarkTest.timeLimitMs = timeLimitMs;
            tablut.Tools.MainBenchmarkTest.alphaBeta = alphaBeta;
            tablut.Tools.MainBenchmarkTest.pvs = pvs;
            tablut.Tools.MainBenchmarkTest.transpositionTable = transpositionTable;
            tablut.Tools.MainBenchmarkTest.killerHeuristik = killerHeuristik;
            tablut.Tools.MainBenchmarkTest.lateMoveReductions = LateMoveReductions;
            tablut.Tools.MainBenchmarkTest.lmrDepth = lmrDepth;
            tablut.Tools.MainBenchmarkTest.lmrMoves = lmrMoves;
